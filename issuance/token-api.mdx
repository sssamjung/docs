---
title: 'Token API'
description: '토큰 정보 조회, 발행, 환수'
---

# Token API

Token API는 토큰의 정보 조회, 발행, 환수 기능을 제공합니다.
...
<CardGroup cols={2}>
  <Card title="파티션 관리" icon="folder" href="/issuance/partition">
    토큰 파티션 생성 및 관리
  </Card>
  <Card title="토큰 발행 가이드" icon="book" href="/issuance/issue-token">
    토큰 발행 전체 흐름 이해하기
  </Card>
</CardGroup>
